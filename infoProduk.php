	...
	<div class="wrapper">
		...
		<div class="konten">
			...
			<div class="pos">
				...
				<label class="ljudul"><?php echo $data['namaB'];?> </label>
				<label class="lkonten"><?php echo $data['keterangan'];?></label>
				

			</div>	
			<div class="pos1">
				<label class="pnama">Nama Barang : <?php echo $data['namaB'];?></label>
				<br>
				<label class="pnama">Kategori : <?php echo $data['kategori'];?></label>
				<br>
				<label class="pnama">Harga : Rp.<?php echo $data['harga'];?> </label>
				<br>
				<label class="pnama">Stok : <?php echo $data['stok'];?></label>
