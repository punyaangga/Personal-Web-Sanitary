	...
	<div class="wrapper">
		...
		<div  class="konten">
			...
			<?php
					...
					$query=mysqli_query($con,"SELECT * FROM produk WHERE kategori ='$nama'");
			...
			<div class="even1">
				...
				<div class="k1">
						...
						<br>
						<label id="flabel">Harga : <?php echo $data['harga'];?></label>
						<br>
						<label id="flabel">Stok : <?php echo $data['stok'];?></label>
						<br>
						<label id="flabel">Kategori : <?php echo $data['kategori'];?></label>
						<br>
						<br>
