...
<body>
	...
	<div class="wrap">
		...
		<div class="bkonten">
			...
			<div class="konten">
				<div class="post-info">
					<b><center>Edit Kontak Kami</center></b>
					<hr>
				</div>
				<?php
					...
					<div id="myDIV">
						<form method="POST" action="konfigurasi/TKontak.php" class="login-form">
							...
							<div class="input-container">
								<label>Alamat :</label>
								<textarea name="alamat" class="input"><?php echo $data['alamat'];?></textarea>
								
							</div>
							
							<div class="input-container">
								<label>Mobile :</label>
								<input type="number" class="input" name="mobile" value="<?php echo $data['mobile'];?>"/>
							</div>
